  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p className="mt-3">
          The production service may use hosting, database, Redis queue,
          authentication, and observability providers such as Vercel, Railway,
          PostgreSQL, Redis, and GitHub. These providers process data only as
